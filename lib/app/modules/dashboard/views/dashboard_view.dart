...
import 'package:tokosenjata/app/data/EntertainmentResponse.dart';
    ...
    child: Column(
      children: [
        ...
        const Padding(
          ...
          child: Text(
            'Halo, perkenalkan nama saya Gybran 0108. Saya seorang siswa di SMK Assalaam Bandung yang saat ini sedang belajar pemrograman web. Untuk saat ini saya sudah memiliki pengetahuan dasar tentang beberapa bahasa pemrograman dan beberapa framework seperti PHP, HTML, CSS, Javascript, Bootstrap, Laravel, Flutter, dll.',
            style: TextStyle(
              fontSize: 16,
